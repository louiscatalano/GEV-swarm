...
static const _AgentState_type_support_symbol_names_t _AgentState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_msgs, msg, AgentState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, environment_msgs, msg, AgentState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, environment_msgs, msg, AgentState)() {
  return &::environment_msgs::msg::rosidl_typesupport_c::AgentState_message_type_support_handle;
}
