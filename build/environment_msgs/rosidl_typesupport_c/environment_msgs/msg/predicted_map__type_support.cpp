...
static const _PredictedMap_type_support_symbol_names_t _PredictedMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_msgs, msg, PredictedMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, environment_msgs, msg, PredictedMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, environment_msgs, msg, PredictedMap)() {
  return &::environment_msgs::msg::rosidl_typesupport_c::PredictedMap_message_type_support_handle;
}
