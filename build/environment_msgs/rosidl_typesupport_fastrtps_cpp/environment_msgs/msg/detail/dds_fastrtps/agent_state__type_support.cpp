...
#include "environment_msgs/msg/detail/agent_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const environment_msgs::msg::AgentState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  environment_msgs::msg::AgentState & ros_message)
{
  // Member: agent_id
  cdr >> ros_message.agent_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_environment_msgs
max_serialized_size_AgentState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_msgs::msg::AgentState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_environment_msgs
max_serialized_size_key_AgentState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const environment_msgs::msg::AgentState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<environment_msgs::msg::AgentState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AgentState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const environment_msgs::msg::AgentState *>(
...
static size_t _AgentState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AgentState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AgentState__callbacks = {
...
static rosidl_message_type_support_t _AgentState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AgentState__callbacks,
...
{
  return &environment_msgs::msg::typesupport_fastrtps_cpp::_AgentState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, environment_msgs, msg, AgentState)() {
  return &environment_msgs::msg::typesupport_fastrtps_cpp::_AgentState__handle;
}
