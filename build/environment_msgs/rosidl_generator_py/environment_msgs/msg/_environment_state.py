    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'environment_msgs.msg.EnvironmentState')
            logger.debug(
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'forbidden' field must be a set or sequence and each value of type 'bool'"
